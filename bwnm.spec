...
bwnm jest nową wersją wnm. Wykorzystuje nmap-a do znalezienia
wszystkich komputerów pod podanym zakresem IP z otwartymi portami
netbiosu, a następnie wykorzystując nmblookup i smbmount montuje
wszystkie dostępne zasoby w bieżącym katalogu. wnum pozwala na łatwe
